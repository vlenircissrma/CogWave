...
BlindOFDM_Sensing::BlindOFDM_Sensing(){


}

vec BlindOFDM_Sensing::spectrum_block(cvec rx_buff, int Nfft)
{
...
int BlindOFDM_Sensing::best_group(vec spectrum_sensed,int num_subchannels){
    ...
    for(int i=0;i<num_subchannels;i++)
        integrate_sensing[i]=sum(spectrum_sensed.get(i*(spectrum_sensed.size()/num_subchannels),(i+1)*(spectrum_sensed.size()/num_subchannels)-1));
...
int BlindOFDM_Sensing::best_group_mask(vec spectrum_sensed,int num_subchannels){
