...
void Point_to_Point_TDD_TX::setvalue(int value){
...
void Point_to_Point_TDD_TX::setwaveform(int value){
...
void Point_to_Point_TDD_TX::update_uhd(){
...
void Point_to_Point_TDD_TX::run(){
...
/*            //Solution which send the packet in every slot until the packet gets updated.
            ...
            if(previous_tx_timestamp!=tx_timestamp){
                ...
                if(nb_read>0){
                    ...
                    //cout << "TIMESTAMP TO SEND " << tx_timestamp << endl;
