...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "point_to_point_tdd_performance_test.h"
#include <net/if.h>
...
Point_to_Point_TDD_Performance_Test::Point_to_Point_TDD_Performance_Test(Ui_MainWindow *ui)
{
    ...
    for(int i=0;i<number_transceivers;i++){
        ...
        Point_to_Point_TDD_TX *tmp=new Point_to_Point_TDD_TX(ui,fd_ext);
        Point_to_Point_TDD_RX *tmp2=new Point_to_Point_TDD_RX(ui,fd_ext);
...
int Point_to_Point_TDD_Performance_Test::tun_alloc(char *dev)
{
    struct ifreq ifr;
    int fd, err;
...
void Point_to_Point_TDD_Performance_Test::run(){
