...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "csma_performance_test.h"
#include <net/if.h>
...
CSMA_Performance_Test::CSMA_Performance_Test(Ui_MainWindow *ui)
{
    ...
    for(int i=0;i<number_transceivers;i++){
        ...
        CSMA_TX *tmp=new CSMA_TX(ui,fd_ext);
        CSMA_RX *tmp2=new CSMA_RX(ui,fd_ext);
    ...
    for(int i=0;i<number_transceivers;i++){
        ...
        QObject::connect(receivers[i],SIGNAL(signal_detect(bool)),transmitters[i],SLOT(signal_detected(bool)),Qt::BlockingQueuedConnection);
...
int CSMA_Performance_Test::tun_alloc(char *dev)
{
    struct ifreq ifr;
    int fd, err;
...
void CSMA_Performance_Test::run(){
