...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "point_to_point_fdd_performance_test.h"
#include <net/if.h>
...
Point_to_Point_FDD_Performance_Test::Point_to_Point_FDD_Performance_Test(Ui_MainWindow *ui)
{
    ...
    for(int i=0;i<number_transceivers;i++){
        ...
        Point_to_Point_FDD_TX *tmp=new Point_to_Point_FDD_TX(ui);
        Point_to_Point_FDD_RX *tmp2=new Point_to_Point_FDD_RX(ui);
...
int Point_to_Point_FDD_Performance_Test::tun_alloc(char *dev)
{
    struct ifreq ifr;
    int fd, err;
...
void Point_to_Point_FDD_Performance_Test::run(){
