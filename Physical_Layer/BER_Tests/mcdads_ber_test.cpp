...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "mcdads_ber_test.h"

MCDADS_BER_Test::MCDADS_BER_Test()
{
    modem=new Modem_MCDADS();
    int L=1;
    int SF=modem->SF;
...
/*          fading.set_row(1,norm_fading*channel2);
            ...
            int time_offset1,time_offset2;
            vec constellation;
            received_bits=modem->demodulate(received_chips,1,time_offset1,time_offset2,constellation);
            berc.count(transmitted_bits.get(0,transmitted_bits.size()-2), received_bits.get(0,received_bits.size()-2));
