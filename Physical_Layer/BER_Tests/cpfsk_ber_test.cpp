...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "cpfsk_ber_test.h"

CPFSK_BER_Test::CPFSK_BER_Test()
{
    modem=new Modem_CPFSK();
    int L=1;
    int OF=modem->OF;
...
/*          fading.set_row(1,norm_fading*channel2);
            ...
            //M&M with Rectangular Filtering
            berc1.count(transmitted_bits.get(100,NumOfBits-100), received_bits.get(100,NumOfBits-100));
            ber(i) = berc1.get_errorrate();
            berc=berc1;
            berc2.count(transmitted_bits.get(100,NumOfBits-100), received_bits_inverted.get(100,NumOfBits-100));
            if(berc2.get_errorrate()<ber(i)){
                ber(i) = berc2.get_errorrate();
                berc=berc2;
            }
            //M&M without Rectangular Filtering
            /*berc1.count(transmitted_bits.get(101,NumOfBits-100), received_bits.get(100,NumOfBits-101));
            ber(i) = berc1.get_errorrate();
            berc=berc1;
            berc2.count(transmitted_bits.get(101,NumOfBits-100), received_bits_inverted.get(100,NumOfBits-101));
            if(berc2.get_errorrate()<ber(i)){
                ber(i) = berc2.get_errorrate();
                berc=berc2;
            }*/

            cout << transmitted_bits.get(0,32) << endl;
            cout << received_bits.get(0,32) << endl;
