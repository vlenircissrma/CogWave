...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "gmsk_ber_test.h"

GMSK_BER_Test::GMSK_BER_Test()
{
    modem=new Modem_GMSK();
    int L=1;
    int OF=modem->OF;
...
/*          fading.set_row(1,norm_fading*channel2);
            ...
            //PFB demodulator
            berc1.count(transmitted_bits.get(0,NumOfBits-5), received_bits.get(2,NumOfBits-3));
            ber(i) = berc1.get_errorrate();
            berc=berc1;
            berc2.count(transmitted_bits.get(0,NumOfBits-5), received_bits_inverted.get(2,NumOfBits-3));
            if(berc2.get_errorrate()<ber(i)){
                ber(i) = berc2.get_errorrate();
                berc=berc2;
            }
            /*//M&M with Gaussian Filtering
            berc1.count(transmitted_bits.get(100,NumOfBits-103), received_bits.get(103,NumOfBits-100));
            ber(i) = berc1.get_errorrate();
            berc=berc1;
            berc2.count(transmitted_bits.get(100,NumOfBits-103), received_bits_inverted.get(103,NumOfBits-100));
            if(berc2.get_errorrate()<ber(i)){
                ber(i) = berc2.get_errorrate();
                berc=berc2;
            }*/
            //M&M without Gaussian Filtering
            /*berc1.count(transmitted_bits.get(100,NumOfBits-101), received_bits.get(101,NumOfBits-100));
            ber(i) = berc1.get_errorrate();
            berc=berc1;
            berc2.count(transmitted_bits.get(100,NumOfBits-101), received_bits_inverted.get(101,NumOfBits-100));
            if(berc2.get_errorrate()<ber(i)){
                ber(i) = berc2.get_errorrate();
                berc=berc2;
            }*/
