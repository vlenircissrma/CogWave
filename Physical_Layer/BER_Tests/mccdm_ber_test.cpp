...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "mccdm_ber_test.h"

MCCDM_BER_Test::MCCDM_BER_Test()
{
    modem=new Modem_MCCDM();
    int L=1;
...
/*          channel2.set_length(sum_chips.length());
            ...
            //channel1.replace_mid(0,randn_c()*ones(sum_chips.length()-1));
...
/*          fading.set_row(1,norm_fading*channel2);
            ...
            received_chips = channel(transmitted_symbols/*elem_mult(sum_chips,exp(to_cvec(zeros(sum_chips.size()),4.14*ones(sum_chips.size()))))*/);

            //received_chips = sum_chips;
            int time_offset;
            cvec constellation;
            received_bits=modem->demodulate(received_chips,time_offset,constellation);
            berc.count(transmitted_bits.get(2,transmitted_bits.size()-1), received_bits.get(2,received_bits.size()-1));
