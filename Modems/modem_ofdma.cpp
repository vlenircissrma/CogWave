...
#include "modem_ofdma.h"

Modem_OFDMA::Modem_OFDMA()
{
    Nfft=512;
    Ncp=128;
    num_subchannels=4;
...
cvec Modem_OFDMA::modulate_mask_qpsk(bvec data_packet, int best_group)
{
...
bool Modem_OFDMA::detection(cvec rx_buff,double &metric)
{
...
cvec Modem_OFDMA::equalizer_fourth_power(cvec rx_buff, int best_group, vec &estimated_channel)
{
...
bvec Modem_OFDMA::demodulate_mask_gray_qpsk(cvec demodulated_ofdm_symbols, int best_group, cvec &constellation)
{
...
bool Modem_OFDMA::preamble_detection_qpsk(bvec received_bits,bvec &received_bits2,int &preamble_start){
...
bvec Modem_OFDMA::charvec2bvec(vector<char> input){
