...
Waveform_TDD_TX::Waveform_TDD_TX(Ui_MainWindow *ui)
{
...
void Waveform_TDD_TX::setvalue(bool value, double value2){
...
void Waveform_TDD_TX::setvalue(int value){
...
void Waveform_TDD_TX::setwaveform(int value){
...
void Waveform_TDD_TX::update_uhd(){
...
void Waveform_TDD_TX::run(){
    ...
    while(!stop_signal){
        ...
        if((last_waveform!=waveform)&&(waveform==1)){
         ...
         int Number_of_received_symbols=SF*nb_bits*OF;
        ...
        if((last_waveform!=waveform)&&(waveform==3)){
            ...
            int OF=bpsk->OF;
            int Number_of_received_symbols=nb_bits*OF;
            int number_of_slots=2;
            time_gap=number_of_slots*(Number_of_received_symbols/rxrate);
            cout << "TIME GAP TX " << time_gap << endl;
            device->time_gap=time_gap;
        ...
        if((last_waveform!=waveform)&&(waveform==5)){
            ...
            int OF=qpsk->OF;
            int Number_of_received_symbols=nb_bits*OF/2;
            int number_of_slots=2;
            time_gap=number_of_slots*(Number_of_received_symbols/rxrate);
            cout << "TIME GAP TX " << time_gap << endl;
            device->time_gap=time_gap;
