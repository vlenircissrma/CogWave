...
void DADS_UHDDevice::setvalue(int value){
...
double DADS_UHDDevice::time()
{
  return usrp->get_time_now().get_real_secs();
}

void DADS_UHDDevice::set_time(double sync_time)
{
    usrp->set_time_now(uhd::time_spec_t(sync_time+time()));
}

cvec DADS_UHDDevice::readsamples(int Nsamples,double timestamp)
{
...
void DADS_UHDDevice::sendsamples(cvec tx_buff,double timestamp){
...
void DADS_UHDDevice::txerrors(double timestamp){
